...
public class HanoiFrame extends JFrame implements ActionListener{
    ...
    public HanoiFrame() {
        ...
        pre = new JButton("ÉÏÒ»²½");
        pre.setFont(new Font("Î¢ÈíÑÅºÚ",1,20));
        next = new JButton("ÏÂÒ»²½");
        next.setFont(new Font("Î¢ÈíÑÅºÚ",1,20));
        init = new JButton("³õÊ¼»¯");
        init.setFont(new Font("Î¢ÈíÑÅºÚ",1,20));
        label = new Label("ÅÌ×Ó¸öÊý:");
        label.setFont(new Font("Î¢ÈíÑÅºÚ",1,20));
        input = new TextField("5", 8);
        input.setFont(new Font("Î¢ÈíÑÅºÚ",1,20));
